...
import SpriteLists from './sprite-lists.jsx';
...
const SpriteSelectorComponents = function (props) {
    const {
        editingTarget,
        hoveredTarget,
        intl,
    ...
    return (
        ...
        >
            ...
            />
            {/* <div>sprite customes list</div> */}
        </Box>
    );
};

SpriteSelectorComponents.propTypes = {
...
export default injectIntl(SpriteSelectorComponents);
