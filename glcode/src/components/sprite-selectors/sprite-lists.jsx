...
import SpriteSelectorItems from '../../containers/sprite-selector-items.jsx';
import SortableHOC from '../../lib/sortable-hoc.jsx';
import SortableAsset from '../asset-panel/sortable-asset.jsx';
import ThrottledPropertyHOC from '../../lib/throttled-property-hoc.jsx';

import styles from './sprite-selectors.css';

const ThrottledSpriteSelectorItem = ThrottledPropertyHOC('asset', 500)(SpriteSelectorItems);

const SpriteLists = function (props) {
    const {
        containerRef,
        editingTarget,
        draggingIndex,
...
export default SortableHOC(SpriteLists);
