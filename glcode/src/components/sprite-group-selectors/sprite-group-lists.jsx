...
const SpriteGroupLists = function (props) {
    const {
        containerRef,
        editingTarget,
        draggingIndex,
            ...
            >
                {items.map((sprite, index) => {
                    ...
                    return (
                        ...
                        >
                            {sprite.customField&&sprite.customField.groupName?
                            <div id="sprite-group-lists.jsx" className={styles.spriteGroup}>
                                <div>{sprite.customField.groupName}</div>
...
export default SortableHOC(SpriteGroupLists);
