...
class MenuBar extends React.Component {
    ...
    componentDidMount () {
        document.addEventListener('keydown', this.handleKeyPress);
           console.log(this.props.aboutMenuOpen,"aa")
    }
    ...
    handleCearclick () {
       if(window.scratchConfig && window.scratchConfig.menuBar.crearButton){
        ...
        // 这个就是国际化
  console.log(this.props.intl,"aac",this.props.enableCommunity)  
        ...
        return (
            ...
            >
                <div className={styles.mainMenu}>
                                    ...
                                    <MenuSection>
                                        {(window.scratchConfig && window.scratchConfig.menuBar && window.scratchConfig.menuBar.newButton && 
                                            ...
                                            >
                                             ...
                                             <MenuSection>
                                        {(window.scratchConfig && window.scratchConfig.menuBar && window.scratchConfig.menuBar.saveaAs && 
                                            window.scratchConfig.menuBar.saveaAs.show) && (
                                            <MenuItem
                                                isRtl={this.props.isRtl}
                    ...
                    {/* 这里就是头部输入框 */}
                    <div onClick={this.props.onBackpackClick}>背包</div>
                        ...
                        <React.Fragment>
                            {
                                    (window.scratchConfig && window.scratchConfig.menuBar && window.scratchConfig.menuBar.myStuff.show) && (          
                                        <Menutop
                                            onSaveChange={this.checkouNewClick.bind(this) }
