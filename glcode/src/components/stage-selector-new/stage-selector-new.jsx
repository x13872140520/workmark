...
import styles from "./stage-selector-new.css";
...
const StageSelectorNew = (props) => {
    ...
    console.log("StageSelectorNewprops", props);
    return (
        <Box
...
export default injectIntl(StageSelectorNew);
