...
import styles from "./librarys.css";
...
class LibrarysComponent extends React.Component {
    constructor(props) {
        super(props);
        bindAll(this, [
            "handleClose",
    ...
    handleTagClick(tag) {
        console.log("handleTagClickok", tag);
...
LibrarysComponent.propTypes = {
    ...
    tags: PropTypes.arrayOf(PropTypes.shape(TagButtons.propTypes)),
    title: PropTypes.string.isRequired,
    onCancel: PropTypes.func,
};

LibrarysComponent.defaultProps = {
    filterable: true,
    showPlayButton: false,
};

export default injectIntl(LibrarysComponent);
