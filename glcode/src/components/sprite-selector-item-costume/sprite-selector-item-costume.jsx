...
import styles from './sprite-selector-item-costume.css';
import {ContextMenuTrigger} from 'react-contextmenu';
import {DangerousMenuItem, ContextMenu, MenuItem} from '../context-menu/context-menu.jsx';
import {FormattedMessage} from 'react-intl';
import {IconCopy,IconEdit,IconDelete} from '../../components/download-icon/download-icon.jsx';
// react-contextmenu requires unique id to match trigger and context menu
let contextMenuId = 0;

const SpriteSelectorItemCostume = props => (
    <ContextMenuTrigger
        attributes={{
...
SpriteSelectorItemCostume.propTypes = {
...
export default SpriteSelectorItemCostume;
