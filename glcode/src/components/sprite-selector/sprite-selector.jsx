...
const SpriteSelectorComponent = function (props) {
    ...
    if (Object.keys(selectedSprite).length == 0) {
        selectedSprite = stage;
        console.log("设置selectedSprite为stage", selectedSprite);
    }
    const [disacount, Setdisacount] = useState(false);
    // const commit=useSubscribe("commit",(msg,data)=>{
    ...
    return (
        <Box className={styles.spriteSelector} {...componentProps}>
            <SpriteInfo
                ...
                hanDisableClick={handleDisableClick}
            ...
            /> */}
            {/* ActionMenu 这是上传角色 随机 绘制 选择一个角色面板  两进两出*/}
            {/* <ActionMenu
