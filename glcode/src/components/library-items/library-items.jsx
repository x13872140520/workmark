...
import styles from "./library-items.css";
...
class LibraryItemsComponent extends React.PureComponent {
    render() {
        return this.props.featured ? (
            ...
            >
                <ContextMenuTrigger
                    ...
                    attributes={{
                        className: classNames("libraryItemContext"),
                    }}
                >
                    ...
                    {this.props.showCancelButton ? (
                        <ContextMenu
                            id={`menu${this.props.id}`}
                            attributes={{
                                className: classNames("libraryItemContextMenu"),
                            }}
                        >
                            <MenuItem
                                onClick={(e) => {
                                    ...
                                    this.props.onCancelAdopt(this.props.id);
                                }}
                            >
                                <FormattedMessage
                                    defaultMessage="Remove It"
                                    description="remove it from backpack,you can add it back by general site"
                                    id="gui.backpack.cancelAdopt"
                                />
                            </MenuItem>
                        </ContextMenu>
                    ) : null}
...
LibraryItemsComponent.propTypes = {
...
LibraryItemsComponent.defaultProps = {
    disabled: false,
    showPlayButton: false,
};

export default LibraryItemsComponent;
