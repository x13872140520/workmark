...
import styles from "./action-menu-new.css";
import {
    useSubscribe,
    usePublish,
    useUnsubscribe,
} from "../../Pusconnect/usePubSub";
import { IconSinglePlus } from "../../components/download-icon/download-icon.jsx";
import ClickAwayListener from "@material-ui/core/ClickAwayListener";
const CLOSE_DELAY = 50; // ms

class ActionMenuNew extends React.Component {
    constructor(props) {
        super(props);
        bindAll(this, [
            "clickDelayer",
    ...
    render() {
        ...
        return (
            ...
            >
                <div
                    id="ActionMenuNew"
                    className={classNames(styles.menuContainerNew, className, {
