...
const ProjectSaverHOC = function (WrappedComponent) {
    class ProjectSaverComponent extends React.Component {
        constructor (props) {
            console.log('ProjectSaverComponentxx',props)
            super(props);
            bindAll(this, [
                'getProjectThumbnail',
                'leavePageConfirm',
        ...
        tryToAutoSave () {
            console.log('tryToAutoSave',this.props)
            ...
            return Promise.all(this.props.vm.assets
                ...
                .map(
                    asset => storage.store(
                        ...
                        // 服务端需要写个post请求如http://182.61.146.154/79f8ba0833c03941908deb0339b39c82.png来保存对应的资源 
        ...
        render () {
            ...
            return (
                    ...
                    storeProject={this.storeProject.bind(this)}
                    {...componentProps}
                    />
