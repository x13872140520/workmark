...
export default defineMessages({
    ...
    uav: {
        defaultMessage: 'UAV',
        description: 'Tag for filtering a library for uav',
        id: 'gui.libraryTags.uav'
    },
    telecar: {
        defaultMessage: 'Telecar',
        description: 'Tag for filtering a library for telecar',
        id: 'gui.libraryTags.telecar'
    },
    robot: {
    ...
    michanicalarm: {
        defaultMessage: 'Michanical Arm',
        description: 'Tag for filtering a library for michanicalarm',
        id: 'gui.libraryTags.michanicalarm'
    },
    stage: {
