...
const MODAL_BACKPACK_LIBRARY = 'backpackLibrary';
...
const MODAL_SPRITE_LIBRARY3IN1 = 'spriteLibrary3in1';
const MODAL_SOUND_RECORDER = 'soundRecorder';
const MODAL_CONNECTION = 'connectionModal';
const MODAL_TIPS_LIBRARY = 'tipsLibrary';
const MODAL_COSTUME_PAINT = 'costumePaint';

const initialState = {
    [MODAL_BACKDROP_LIBRARY]: false,
    [MODAL_BACKPACK_LIBRARY]: false,
    ...
    [MODAL_SPRITE_LIBRARY3IN1]: false,
    [MODAL_SOUND_RECORDER]: false,
    [MODAL_CONNECTION]: false,
    [MODAL_TIPS_LIBRARY]: false,
    [MODAL_COSTUME_PAINT]: false,
};
...
const openBackpackLibrary = function () {
    return openModal(MODAL_BACKPACK_LIBRARY);
};
...
const openSpriteLibrary3in1 = function () {
    return openModal(MODAL_SPRITE_LIBRARY3IN1);
};
...
const openCostumePaintModal = function () {
    return openModal(MODAL_COSTUME_PAINT);
};
const closeBackdropLibrary = function () {
    return closeModal(MODAL_BACKDROP_LIBRARY);
};
const closeBackpackLibrary = function () {
    return closeModal(MODAL_BACKPACK_LIBRARY);
};
...
const closeSpriteLibrary3in1 = function () {
    return closeModal(MODAL_SPRITE_LIBRARY3IN1);
};
...
const closeCostumePaintModal = function () {
    return closeModal(MODAL_COSTUME_PAINT);
};
