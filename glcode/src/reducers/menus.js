...
const openSettingMenu = () => openMenu(MENU_SET);
const closeSettingMenu = () => closeMenu(MENU_SET);
const fileMenuOpen = state => state.scratchGui.menus[MENU_FILE];
const settingMenuOpen = state => state.scratchGui.menus[MENU_SET];
