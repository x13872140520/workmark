...
import SpriteSelectorItemCostumeComponent from '../components/sprite-selector-item-costume/sprite-selector-item-costume.jsx';

class SpriteSelectorItemCostume extends React.PureComponent {
    constructor (props) {
        super(props);
        bindAll(this, [
            'getCostumeData',
    ...
    render () {
        ...
        return (
            <SpriteSelectorItemCostumeComponent
