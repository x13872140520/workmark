...
import LibraryItemsComponent from "../components/library-items/library-items.jsx";
import { setCancel } from "../utils/api.js";
import {
    useSubscribe,
    usePublish,
    useUnsubscribe,
    ...
    render() {
        ...
        const iconURL = iconMd5
            ? // `https://cdn.assets.scratch.mit.edu/internalapi/asset/${iconMd5}/get/` :
              `/${process.env.FILE_PATH}/${iconMd5}/get/`
...
export default injectIntl(LibraryItems);
