...
class SpriteSelectorItem extends React.PureComponent {
    ...
    componentWillUnmount () {
         ...
         let commit=useSubscribe("commit",(msg,data)=>{

         if(msg==="commit" && data){
          
                this.newhandleDelete()
         }
         })
          unsubscribe(commit);
...
const mapDispatchToProps = dispatch => ({
    ...
    onDrag: data =>{
        console.log('sprite-seletor-item.jsx onDrag',updateAssetDrag(data))
        dispatch(updateAssetDrag(data))} 
});
