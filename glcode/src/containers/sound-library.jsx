...
class SoundLibrary extends React.PureComponent {
    ...
    componentDidMount() {
        ...
        getMaterial({
            ...
            if (result.data.data.records) {
                ...
                that.setState({
                    mysoundLibraryThumbnailData: mydata,
                });

                console.log(
                    "mysoundLibraryThumbnailData",
                    that.state.mysoundLibraryThumbnailData
                );
            } else {
            }
        });
    ...
    render() {
        ...
        // console.log('formystate',this.state)
        ...
        return (
            <LibraryComponent
                showPlayButton
                data={this.state.mysoundLibraryThumbnailData}
                id="soundLibrary"
                setStopHandler={this.setStopHandler}
                tags={this.state.soundTags}
