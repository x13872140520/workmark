...
class RenderedTarget extends Target {
    ...
    setSize (size) {
        ...
        if (this.renderer) {
            ...
            console.log('costumeSize',costumeSize)
            ...
            console.log('runtime',this.runtime.constructor.STAGE_WIDTH,this.runtime.constructor.STAGE_HEIGHT)
            this.size = MathUtil.clamp(size / 100, minScale, maxScale) * 100;
            console.log('minScale',minScale)
            console.log('maxScale',maxScale)
            console.log('thissize',this.size)
            const {direction, scale} = this._getRenderedDirectionAndScale();
            console.log('wtf',this.drawableID, direction, scale)
     ...
     */
    postSpriteInfo (data) {
        console.log('postSpriteInfo',data)
