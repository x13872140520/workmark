...
export default {
  "en": {
    ...
    "gui.backpack.cancelAdopt": "Remove it",
    "gui.backpack.backpacktip": "Material backpack",
    ...
    "gui.accountMenu.signInByPwd": "Account Login",
    "gui.accountMenu.signInByMes": "Phone Login",
    "gui.accountMenu.usernameByPwd": "Phone/Mail/Username",
    "gui.accountMenu.passwordByPwd": "Password",
    "gui.accountMenu.usernameByMes": "Phone Number",
    "gui.accountMenu.passwordByMes": "Verification Code",
    "gui.accountMenuTip.phoneError": "incorrect phone format",
    "gui.accountMenuTip.vcError": "verification cannot be empty and miss specification",
    "gui.accountMenuTip.sendOk": "send successfully",
    "gui.accountMenuTip.sendFail": "send fail",
    "gui.accountMenuTip.LoginOK": "login successfully",
    "gui.accountMenuTip.accountMiss": "account cannot be empty",
    "gui.accountMenuTip.passwordMiss": "password cannot be empty",
    "gui.accountMenuTip.phoneMiss": "phonenumber cannot be empty",
    ...
    "gui.menuBar.openProject": "Open Project",
    "gui.menuBar.createProject": "Create Project",
    "gui.menuBar.personalProject": "Your Project",
    ...
    "gui.menuBar.chooseLanguage": "Choose language",
    "gui.menuBar.theme": "Theme",
    "gui.menuBar.createGroup": "Create Group",
    ...
    "gui.SpriteInfo.disabled": "disabled",
    ...
    "gui.spriteSelector.addSpriteFromLibrary": "Choose a Material",
    ...
    "gui.libraryTags.uav": "UAV",
    "gui.libraryTags.telecar": "Telecar",
    "gui.libraryTags.robot": "Robot",
    "gui.libraryTags.michanicalarm": "Michanical Arm",
    "gui.libraryTags.uavstage": "UAV Stage",
    "gui.libraryTags.telecarstage": "Telecar Stage",
    "gui.libraryTags.robotstage": "Robot Stage",
    "gui.libraryTags.michanicalarmstage": "Michanical Arm Stage",
    "gui.libraryTags.stage": "Stage",
    ...
    "gui.sharedMessages.closePlayerWarning": "After closing, you need to re-enter to open it. Are you sure to close it?",
    "gui.sharedMessages.confirmPlayerWarning": "Sure to close?",
    "gui.sharedMessages.saveProjectWarning": "Save the current work?",
    "gui.sharedMessages.saveTip": "It is recommended to click save works to prevent works from being lost",
    "gui.sharedMessages.nosave": "Do not save",
  ...
  "zh-cn": {
    ...
    "gui.backpack.cancelAdopt": "取消采纳",
    "gui.backpack.backpacktip": "素材背包",
    ...
    "gui.accountMenu.signInByPwd": "密码登录",
    "gui.accountMenu.signInByMes": "短信登录",
    "gui.accountMenu.usernameByPwd": "手机/邮箱/用户名",
    "gui.accountMenu.passwordByPwd": "密码",
    "gui.accountMenu.usernameByMes": "手机",
    "gui.accountMenu.passwordByMes": "验证码",
    "gui.accountMenuTip.phoneError": "手机号格式错误",
    "gui.accountMenuTip.vcError": "验证码不能为空且符合验证码规范",
    "gui.accountMenuTip.sendOk": "短信发送成功",
    "gui.accountMenuTip.sendFail": "短信发送失败",
    "gui.accountMenuTip.LoginOK": "登录成功",
    "gui.accountMenuTip.accountMiss": "账号不能为空",
    "gui.accountMenuTip.passwordMiss": "密码不能为空",
    "gui.accountMenuTip.phoneMiss": "手机号不能为空",
    ...
    "gui.menuBar.openProject": "打开作品",
    "gui.menuBar.createProject": "模板作品",
    "gui.menuBar.personalProject": "个人作品",
    ...
    "gui.menuBar.chooseLanguage": "选择语言",
    "gui.menuBar.theme": "主题",
    "gui.menuBar.createGroup": "创建分组",
    "gui.menuBar.english": "英语",
    "gui.menuBar.china": "简体中文",
    "gui.menuBar.taiwan": "繁体中文",
    "gui.menuBar.edit": "编辑",
    ...
    "gui.spriteSelector.addSpriteFromLibrary": "选素材",
    ...
    "gui.libraryTags.uav": "无人机",
    "gui.libraryTags.telecar": "无人车",
    "gui.libraryTags.robot": "机器人",
    "gui.libraryTags.michanicalarm": "机械臂",
    "gui.libraryTags.uavstage": "无人机场景",
    "gui.libraryTags.telecarstage": "无人车场景",
    "gui.libraryTags.robotstage": "机器人场景",
    "gui.libraryTags.michanicalarmstage": "机械臂场景",
    "gui.libraryTags.stage": "场景",
    ...
    "gui.sharedMessages.closePlayerWarning": "关闭后需要重新进入才能打开，是否确认关闭？",
    "gui.sharedMessages.confirmPlayerWarning": "是否关闭？",
    "gui.sharedMessages.saveProjectWarning": "是否保存当前作品？",
    "gui.sharedMessages.saveTip": "建议点击保存作品，防止作品丢失",
    "gui.sharedMessages.nosave": "不保存",
  ...
  "zh-tw": {
    ...
    "gui.accountMenu.signOut": "登出",
    "gui.accountMenu.signInByPwd": "密碼登錄",
    "gui.accountMenu.signInByMes": "手機號登錄",
    "gui.accountMenu.usernameByPwd": "手機/郵箱/用戶名",
    "gui.accountMenu.passwordByPwd": "密碼",
    "gui.accountMenu.usernameByMes": "手機號",
    "gui.accountMenu.passwordByMes": "驗證碼",
    "gui.accountMenuTip.phoneError": "手機號格式錯誤",
    "gui.accountMenuTip.vcError": "驗證碼不能為空且符合驗證碼規範",
    "gui.accountMenuTip.sendOk": "短信發送成功",
    "gui.accountMenuTip.sendFail": "短信發送失敗",
    "gui.accountMenuTip.LoginOK": "登錄成功",
    "gui.accountMenuTip.accountMiss": "賬號不能為空",
    "gui.accountMenuTip.passwordMiss": "密碼不能為空",
    "gui.accountMenuTip.phoneMiss": "手機號不能為空",
    ...
    "gui.menuBar.openProject": "打開作品",
    "gui.menuBar.createProject": "模板作品",
    "gui.menuBar.personalProject": "個人作品",
    ...
    "gui.menuBar.chooseLanguage": "選擇語言",
    "gui.menuBar.theme": "主題",
    "gui.menuBar.createGroup": "創建分組",
    "gui.menuBar.edit": "編輯",
    ...
    "gui.spriteSelector.addSpriteFromLibrary": "選素材",
    ...
    "gui.libraryTags.uav": "無人機",
    "gui.libraryTags.telecar": "無人車",
    "gui.libraryTags.robot": "機器人",
    "gui.libraryTags.michanicalarm": "機械臂",
    "gui.libraryTags.uavstage": "無人機場景",
    "gui.libraryTags.telecarstage": "無人車場景",
    "gui.libraryTags.robotstage": "機器人場景",
    "gui.libraryTags.michanicalarmstage": "機械臂場景",
    "gui.libraryTags.stage": "場景",
    ...
    "gui.sharedMessages.closePlayerWarning": "關閉後需要重新進入才能打開，是否確認關閉？",
    "gui.sharedMessages.confirmPlayerWarning": "是否關閉？",
    "gui.sharedMessages.saveProjectWarning": "是否保存當前作品",
    "gui.sharedMessages.saveTip": "建議點擊保存作品，防止作品丟失",
    "gui.sharedMessages.nosave": "不保存",
